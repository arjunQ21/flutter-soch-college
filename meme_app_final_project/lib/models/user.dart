...
class User {
  ...
  Future<List<Meme>> getLikedMemes() async {
    ...
    var response = await http.get(
        Uri.parse("$baseApi" "memes" "/liked" "/$id"),
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception( "Error Fetching Liked Memes: ${decodedResponse['message']}");
    }
  }
...
Future<List<Meme>> getPostedMemes() async {
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception( "Error Fetching Posted Memes: ${decodedResponse['message']}");
    }
  }
